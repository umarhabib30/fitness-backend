...
// Packages
use App\Http\Controllers\Admin\TrainerSubscriptionController as AdminTrainerSubscriptionController;
use App\Http\Controllers\Trainer\PackageController as TrainerPackageController;
...
Route::group(['middleware' => ['auth', 'useractive']], function () {
    ...
    Route::group(['prefix' => 'admin'], function () {
        ...
        Route::get('trainer-subscriptions', [AdminTrainerSubscriptionController::class, 'index'])->name('trainer-subscriptions.index');
        Route::post('trainer-subscriptions/{trainerSubscription}/approve', [AdminTrainerSubscriptionController::class, 'approve'])->name('trainer-subscriptions.approve');
        Route::post('trainer-subscriptions/{trainerSubscription}/reject', [AdminTrainerSubscriptionController::class, 'reject'])->name('trainer-subscriptions.reject');

        // Trainer: My Subscription (accessible by users with trainer role)
        Route::get('trainer/my-subscription', [TrainerPackageController::class, 'index'])->name('trainer.packages.index');
        Route::post('trainer/my-subscription/{package}/subscribe', [TrainerPackageController::class, 'subscribe'])->name('trainer.packages.subscribe');
