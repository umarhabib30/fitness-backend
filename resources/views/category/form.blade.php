...
<x-app-layout :assets="$assets ?? []">
    <div>
        <?php $id = $id ?? null;?>
        @if(isset($id))
            {{ html()->modelForm($data, 'PATCH', route('category.update', $id) )->attribute('enctype', 'multipart/form-data')->open() }}
        @else
            {{ html()->form('POST', route('category.store'))->attribute('enctype', 'multipart/form-data')->attribute('data-toggle', 'validator')->open() }} 
        @endif
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="">
                                    <input class="form-control file-input" type="file" name="category_image" accept="image/*">
                                </div>
                            </div>
                            
                            @if( isset($id) && getMediaFileExit($data, 'category_image'))
                                <div class="col-md-2 mb-2 position-relative">
                                    <img id="category_image_preview" src="{{ getSingleMedia($data,'category_image') }}" alt="equipment-image" class="avatar-100 mt-1">
