...
<x-app-layout :assets="$assets ?? []">
    <div>
        <?php $id = $id ?? null;?>
        @if(isset($id))
            {{ html()->modelForm($data, 'PATCH', route('level.update', $id) )->attribute('enctype', 'multipart/form-data')->open() }}
        @else
            {{ html()->form('POST', route('level.store'))->attribute('enctype', 'multipart/form-data')->open() }} 
        @endif
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                {{ html()->label(__('message.rate') . ' <span class="text-danger">*</span>', 'rate')->class('form-control-label') }}
                                {{ html()->number('rate')->placeholder(__('message.rate'))->class('form-control')->attribute('required','required') }}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="">
                                    <input class="form-control file-input" type="file" name="level_image" accept="image/*" id="image">
                                </div>
                            </div>
