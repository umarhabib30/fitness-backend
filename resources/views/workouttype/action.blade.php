...
<div class="d-flex align-items-center">
    ...
    @endif
    {{ html()->form('POST', route('workouttype.destroy', $id))->attribute('data--submit', 'workouttype.$id)->open() }} 
    {{ html()->form()->close() }}   --}}

    @if($auth_user->can('workouttype-delete'))
        {{ html()->form('POST', route('workouttype.destroy', $id))->attribute('data--submit', 'workouttype-delete'.$id)->open() }} 
        {{ html()->hidden('_method', 'DELETE') }}
        <a class="btn btn-sm btn-icon btn-danger" href="javascript:void(0)" data-bs-toggle="tooltip" data--submit="workouttype-delete{{$id}}" 
            data--confirmation='true' data-title="{{ __('message.delete_form_title',[ 'form'=> __('message.workouttype') ]) }}"
            title="{{ __('message.delete_form_title',[ 'form'=>  __('message.workouttype') ]) }}"
            data-message='{{ __("message.delete_msg") }}'>
            <span class="btn-inner">
