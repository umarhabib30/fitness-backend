...
<div class="d-flex align-items-center">
    ...
    @if($auth_user->can('categorydiet-delete'))
        {{ html()->form('POST', route('categorydiet.destroy', $id))->attribute('data--submit', 'categorydiet-delete'.$id)->open() }} 
        {{ html()->hidden('_method', 'DELETE') }}
            <a class="btn btn-sm btn-icon btn-danger" href="javascript:void(0)" data-bs-toggle="tooltip" data--submit="categorydiet-delete{{$id}}" 
