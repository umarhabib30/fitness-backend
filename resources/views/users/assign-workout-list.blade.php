        ...
        <tr>
            ...
            <td>
                <a class="btn btn-sm btn-icon btn-danger" 
                    ...
                    data--ajax='true'
                    data-title="{{ __('message.delete_form_title',[ 'form'=> __('message.assignworkout') ]) }}"
                    title="{{ __('message.delete_form_title',[ 'form'=>  __('message.assignworkout') ]) }}"
...
@else
    <tr>
        <td colspan="3">
            {{ __('message.not_found_entry', [ 'name' => __('message.workout') ]) }}
        </td>
    </tr>
@endif